                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    {litige.agents.map((a, i) => (
                      <span key={`${litige.id}-agent-${i}`} style={{ background: 'rgba(255,255,255,0.07)', color: 'white', padding: '4px 10px', borderRadius: '6px', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <User size={12} /> {a}
                      </span>
                    ))}
                  </div>
