...
export default function PointageCourriers() {
  ...
  return (
    <div className="fade-in" style={{ paddingBottom: '40px' }}>
      ...
      {/* Notification Banner */}
      {notifSent && (
        <div style={{ background: 'rgba(16,185,129,0.15)', border: '1px solid rgba(16,185,129,0.4)', borderRadius: '12px', padding: '14px 20px', marginBottom: '20px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <span style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.5px', opacity: 0.9, fontWeight: 'bold', color: '#10b981' }}>JARVIS ASSISTANT</span>
