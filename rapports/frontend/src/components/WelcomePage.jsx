...
export default function WelcomePage({ setView }) {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      // Le canvas doit prendre toute la hauteur de son parent (la section) même si elle dépasse 100vh
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0b1220', color: 'white', overflowX: 'hidden', margin: '-24px' }}>
      
      {/* HEADER / NAVIGATION */}
      <header style={{
        position: 'fixed', top: 0, left: 0, right: 0, padding: '20px 40px', zIndex: 100,
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
        background: scrolled ? 'rgba(11, 18, 32, 0.95)' : 'rgba(11, 18, 32, 0.8)',
      ...
      <section style={{ 
        ...
        position: 'relative', padding: '140px 20px 80px', textAlign: 'center', overflow: 'hidden'
      }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
            {features.map((feat, idx) => (
              <div key={feat.title || `feature-${idx}`} style={{ 
      ...
      {/* FOOTER */}
      <footer style={{ background: '#070b14', padding: '60px 40px', borderTop: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexWrap: 'wrap', gap: '40px', justifyContent: 'space-between' }}>
        <div style={{ flex: '1', minWidth: '250px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
            <img src="/elysium_logo.png" alt="Logo" style={{ width: '30px', height: '30px' }} />
            <span style={{ fontWeight: 800, fontSize: '1.2rem', color: 'white' }}>ELYSIUM</span>
          </div>
        ...
        <div style={{ display: 'flex', gap: '60px', flexWrap: 'wrap' }}>
          <div>
            <h4 style={{ color: 'white', fontWeight: 700, marginBottom: '16px' }}>Légal</h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <li><a href="#" style={{ color: '#94a3b8', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={e => e.target.style.color = 'white'} onMouseLeave={e => e.target.style.color = '#94a3b8'}>Confidentialité</a></li>
              <li><a href="#" style={{ color: '#94a3b8', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={e => e.target.style.color = 'white'} onMouseLeave={e => e.target.style.color = '#94a3b8'}>Conditions d'utilisation</a></li>
              <li><a href="#" style={{ color: '#94a3b8', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={e => e.target.style.color = 'white'} onMouseLeave={e => e.target.style.color = '#94a3b8'}>Mentions légales</a></li>
            </ul>
          </div>
        </div>

        <div style={{ width: '100%', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '24px', marginTop: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: '#94a3b8', fontSize: '0.85rem' }}>
          <span>&copy; 2026 ELYSIUM Technologies. Tous droits réservés.</span>
