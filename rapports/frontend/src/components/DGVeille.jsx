      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px', alignItems: 'start' }}>
          ...
          {INDICATORS.map(cat => (
            <div key={cat.category} className="glass-panel" style={{ padding: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {cat.items.map((item) => (
                  <div key={item.label} style={{ padding: '16px', background: 'rgba(255,255,255,0.03)', borderRadius: '10px', border: `1px solid rgba(255,255,255,0.06)`, display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div className="glass-panel" style={{ padding: '20px' }}>
            ...
            {ACTU.map((a, i) => (
              <div key={a.title || `actu-${i}`} style={{ padding: '14px 0', borderBottom: i < ACTU.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none' }}>
