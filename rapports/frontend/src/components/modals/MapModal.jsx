          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <button
              ...
              style={{
                ...
                background: (!startDate || !endDate) ? 'rgba(239,68,68,0.3)' : 'linear-gradient(135deg, #ef4444 0%, #dc2626 100%)',
                ...
                boxShadow: (!startDate || !endDate) ? 'none' : '0 6px 15px rgba(239,68,68,0.3)',
                transition: 'all 0.2s'
              }}
            >
