...
export default function PaymentAuditModal({ currentSalaries, currentPeriod, onClose }) {
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(10px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 10000 }}>
      <div style={{ background: '#0f172a', width: '90%', maxWidth: '1000px', maxHeight: '90vh', borderRadius: '24px', display: 'flex', flexDirection: 'column', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5)', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <p style={{ margin: '4px 0 0 0', color: 'var(--muted)', fontSize: '0.95rem' }}>
                Comparaison de <strong>{currentPeriod}</strong> avec le mois précédent (<strong>{getPrevPeriod(currentPeriod)}</strong>)
              </p>
            </div>
          </div>
