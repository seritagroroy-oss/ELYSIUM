...
export default function ContextMenu({
  ...
  let defaultOpts = [
    ...
    { code: 'A', label: 'Absence Injustifiée', color: '#ff0000', type: 'cell', active: true, readonlyCode: true, group: 'Absences & Congés', danger: true },
  ...
  return (
    <div style={{
      ...
      background: '#1e293b', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', zIndex: 100000, boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5), 0 0 0 100vmax rgba(0,0,0,0.2)', overflowY: 'auto', maxHeight: '90vh', display: 'flex', flexDirection: 'column', width: '800px', maxWidth: '95vw', padding: '16px'
    }}>
      {groupOrder.map((groupName, gIndex) => {
        ...
        return (
          <div key={groupName} style={{ marginBottom: gIndex < groupOrder.length - 1 ? '16px' : '0' }}>
            <div style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', padding: '0 8px 8px', letterSpacing: '0.1em', fontWeight: 700 }}>
              {groupName}
            </div>
