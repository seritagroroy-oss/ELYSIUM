  ...
  return (
    <div className="top-bar glass-panel" style={{ 
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
        ...
        {/* GAUCHE : Mes Sites & Recherche */}
        <div style={{ display: 'flex', alignItems: 'center', flexShrink: 0, flex: 1, gap: '16px' }}>
          <button className="btn btn-secondary" onClick={() => onBack ? onBack() : backToSites()} style={{ padding: '6px 12px', display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <input
            ...
            style={{ width: '100%', maxWidth: '400px', background: '#ffffff', transition: 'all 0.3s', color: '#000000', textAlign: 'left', paddingLeft: '16px', border: '2px solid rgba(255,255,255,0.3)', margin: 0, marginLeft: '24px' }}
          />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap', flexShrink: 0 }}>
          ...
          {/* MODE PINCEAU */}
          {activeSiteId && setPaintModeActive && (
            <div style={{
              background: paintModeActive ? 'rgba(56,189,248,0.1)' : 'rgba(255,255,255,0.05)', 
              border: `1px solid ${paintModeActive ? '#38bdf8' : 'rgba(255,255,255,0.1)'}`, 
              borderRadius: '8px', padding: '4px 12px', display: 'flex', alignItems: 'center', gap: '8px',
              transition: 'all 0.3s', boxShadow: paintModeActive ? '0 4px 15px rgba(56,189,248,0.2)' : 'none'
            }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '6px', color: paintModeActive ? '#38bdf8' : 'var(--muted)', cursor: 'pointer', fontWeight: 600, fontSize: '0.85rem', margin: 0 }}>
                <input type="checkbox" checked={paintModeActive} onChange={e => setPaintModeActive(e.target.checked)} style={{ width: '14px', height: '14px', accentColor: '#38bdf8' }} />
                🖌️ Pinceau
              </label>
              {paintModeActive && (
                <select value={paintStatus} onChange={e => setPaintStatus(e.target.value)} style={{ background: 'rgba(255,255,255,0.1)', color: 'white', border: '1px solid rgba(255,255,255,0.2)', padding: '2px 8px', borderRadius: '6px', outline: 'none', fontWeight: 'bold', fontSize: '0.8rem' }}>
                  <option value="1" style={{color: 'black'}}>Présent</option>
                  <option value="A" style={{color: 'black'}}>Absent</option>
                  <option value="M" style={{color: 'black'}}>Maladie</option>
                  <option value="CP" style={{color: 'black'}}>Congé</option>
                  <option value="R" style={{color: 'black'}}>Repos</option>
                  <option value="VISUAL_T" style={{color: 'black'}}>Transféré</option>
                  <option value="" style={{color: 'black'}}>Effacer</option>
                </select>
              )}
            </div>
          )}
          ...
          {activeSiteId && setAndSaveAgentSpacingMode && (
