...
if (startIndex === -1) {
    console.error("Impossible de trouver le début du tableau.");
    process.exit(1);
}
...
// Construire le nouveau composant DashboardTable.jsx
...
console.log("Extraction du composant DashboardTable terminée avec succès !");
