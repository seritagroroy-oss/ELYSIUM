...
export default function PaymentMethodModal({ agent, allSalaries = [], onClose, onSubmit }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (paymentMethod === 'NON DEFINI') {
      const updatedProfile = {
        ...profileData,
        payment_method: 'NON DEFINI',
        payment_number: '',
        payment_operator: '',
        payment_country: '',
        payment_rib: '',
        ...
        {!isEditing ? (
          <div>
            {paymentMethod === 'MONEY' ? (
              ...
              <div style={{ background: 'rgba(255,255,255,0.05)', padding: '16px', borderRadius: '8px', marginBottom: '24px' }}>
                <p style={{ color: 'var(--muted)', margin: '0 0 8px 0', fontSize: '0.9rem' }}>Type de paiement : <strong style={{ color: 'white' }}>NON DEFINI</strong></p>
                <p style={{ color: 'var(--muted)', margin: '0', fontSize: '0.9rem' }}>Aucun moyen de paiement configuré.</p>
              </div>
            )}
          ...
          <div className="form-group">
            ...
            >
              ...
              <option value="NON DEFINI" style={{ background: '#1e293b', color: 'white' }}>NON DEFINI</option>
            </select>
          </div>
