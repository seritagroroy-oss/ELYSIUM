...
export default function ConfirmDeleteFunctionModal({ isOpen, onClose, onConfirm, functionName, isLoading }) {
      ...
      >
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            <p style={{ margin: '0 0 24px 0', color: '#94a3b8', fontSize: '0.9rem', lineHeight: '1.5' }}>
              ATTENTION : Cette action supprimera la fonction <strong style={{ color: '#f8fafc' }}>{functionName}</strong> de tous les agents actuellement affectés à ce poste dans le planning en cours.
            </p>
