...
const PermissionDetailsModal = ({
  ...
  const [deletePermissionConfirm, setDeletePermissionConfirm] = useState(null);
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
              ...
              <button onClick={() => {
                ...
                if (modalData.type === 'MAP') {
                  ...
                  if (actions.setEditingMapLeaveId) actions.setEditingMapLeaveId(modalData.id);
                  setMapNavOffset(0);
                  setMapManualDuration('');
                  ...
                  if (actions.setEditingMaladieLeaveId) actions.setEditingMaladieLeaveId(modalData.id);
                  ...
                  if (actions.setEditingPermissionLeaveId) actions.setEditingPermissionLeaveId(modalData.id);
              ...
              <button
                onClick={() => {
                  setDeletePermissionConfirm({
                    type: permissionDetailsModal.type,
                    leave: permissionDetailsModal
                  });
                }}
