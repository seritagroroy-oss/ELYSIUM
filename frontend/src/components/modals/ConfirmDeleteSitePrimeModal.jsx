...
export default function ConfirmDeleteSitePrimeModal({ isOpen, onClose, onConfirm, siteName, isLoading }) {
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            <h3 style={{ margin: '0 0 12px 0', color: '#f8fafc', fontSize: '1.4rem', fontWeight: 600 }}>
              Supprimer la prime de site ?
            </h3>

            <p style={{ margin: '0 0 24px 0', color: '#94a3b8', fontSize: '1rem', lineHeight: '1.5' }}>
              Voulez-vous vraiment supprimer la prime du site <strong style={{ color: '#f8fafc' }}>{siteName}</strong> ?
            </p>
