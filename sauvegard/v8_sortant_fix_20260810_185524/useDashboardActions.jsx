  ...
  const handlePublishPeriod = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        // Nouvelle logique d'archivage dans la BD Archives Pointage
        try {
            const pointageData = { sites, leaves, globalAgents };
            await apiCall('archive_pointage', {
                period: period,
                data: JSON.stringify(pointageData)
            });
            console.log('Archive Pointage enregistrée');
        } catch (err) {
        ...
        // pour éviter une race condition dans le re-render React
