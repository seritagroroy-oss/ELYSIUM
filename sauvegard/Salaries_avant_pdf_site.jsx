        ...
        <div style={{ marginTop: '24px' }}>
                      ...
                      <>
                        ...
                        {journalActuelLoading ? (
                          ...
                          <div className="table-container" style={{ maxHeight: '600px', overflowY: 'auto' }}>
                            ...
                            <th style={{ textAlign: 'left', width: '1%', whiteSpace: 'nowrap', padding: '8px 16px' }}>Site</th>
                            ...
                            {journalActuelData.filter(s =>
                              ...
                              return (<tr key={s.id}>
                                ...
                                <td style={{ textAlign: 'left', padding: '6px 16px', whiteSpace: 'nowrap', color: 'var(--muted)' }}>
                                  {s.archive_site || s.site} / <span style={{ opacity: 0.8 }}>{s.archive_zone || s.subsite || (s.site_location === 'interieur' ? 'Intérieur' : 'Abidjan')}</span>
                                </td>
          ...
          {activeTab === 'masse_salariale' && (
            salariesLoading ? (
              ...
              <MasseSalariale salaries={filteredSalaries.map(s => ({ ...s, computedNet: calculatePayslip(s).netAPayer }))} period={period} payrollSettings={payrollSettings} />
            )
          )}
