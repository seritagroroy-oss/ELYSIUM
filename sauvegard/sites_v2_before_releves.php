...
switch ($action) {
    case 'get_sites':
        ...
        foreach ($sites as &$site) {
            ...
            if (empty($subs) && in_array($site['id'], ['site_releves', 'site_administration', 'site_itc'])) {
        ...
        if ($site_id !== null && $site_id !== '' && $serviceKey) {
            ...
            if ($site) {
                ...
                foreach ($subsites_rows as $sub) {
                    ...
                    $stmt_ag = $sqlite->prepare("SELECT * FROM agents WHERE subsite_id = ? AND company_id = ? AND (archived_period IS NULL OR archived_period = '' OR archived_period >= ?) ORDER BY created_at ASC");
