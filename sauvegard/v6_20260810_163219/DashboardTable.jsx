          ...
          const renderAgentRows = (agent, agentIdx) => {
            ...
            datesList.forEach(d => {
              ...
              ['J', 'N'].forEach(sc => {
                ...
                if (st.startsWith('M|') || st.startsWith('PM|') || st.startsWith('M_1|')) hasMutation = true;
            ...
            const specialBase = (() => {
              if (agent.profile_data && agent.profile_data.special_service) {
                ...
                // Si des jours spécifiques sont configurés, on applique la règle intelligente (scan du mois)
                ...
                // S'il n'y a pas de jours cochés, on utilise la base fixe pour éviter un forfait de 0
                return Number(agent.profile_data.special_service_base) || 12;
              }
              return 30; // 30 jours stricts pour les agents normaux
            })();
            ...
            if (agent.is_clone && agent.days_consumed_by_origin !== undefined) {
                // Règle du site d'origine prioritaire : la destination ne prend que ce qu'il reste pour atteindre la base
                const baseAllowed = Math.max(0, specialBase - agent.days_consumed_by_origin);
                const pWithoutExtra = totalP - totalSpecialExtra;
                totalP = Math.min(pWithoutExtra, baseAllowed) + totalSpecialExtra;
            }
