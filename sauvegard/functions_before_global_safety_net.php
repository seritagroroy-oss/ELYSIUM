            ...
            foreach ($subsites_rows as $sub) {
                ...
                foreach ($agents_rows as $agent) {
                    ...
                    if ($scObj) {
                        ...
                        if ($actual_worked_days > 0 && $total_deductible >= 30) {
                            $max_allowed_deductions = 29;
                            if ($total_deductible > $max_allowed_deductions) {
                                $financial_absence_units = max(0, 29 - $map_count - $permission_count);
                            }
                        }
                    ...
                    $salaries[] = [
                        ...
                        'days_worked' => $is_special ? max(0, ($real_active + $tp_extra_dates_count) - ($absences + $map_count + $permission_count)) : (isset($actual_worked_days) && $actual_worked_days > 0 ? max(1, $active_days - ($absences + $map_count + $permission_count)) : max(0, $active_days - ($absences + $map_count + $permission_count))),
