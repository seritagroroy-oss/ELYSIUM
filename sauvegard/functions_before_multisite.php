...
function buildSiteDataSnapshot($sqlite, $serviceKey, $period, $siteOrder = [])
{
    ...
    // OPTIMISATION N+1: Créer une map subsite_id => orig_site
...
$settings_raw = getServiceDataSql($serviceKey, 'settings', ['cycle_start' => 21, 'cycle_end' => 20]);
        ...
        // On charge la table dédiée special_agents une seule fois pour toute la boucle.
        // Ainsi, le calcul base → prorata → brut → net utilisera le bon montant fixe.
        $special_salary_map = [];
        try {
