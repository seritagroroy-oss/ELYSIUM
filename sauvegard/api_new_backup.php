...
$public_actions = ['login', 'logout', 'register', 'request_password_reset', 'login_agent_portal', 'register_agent_portal', 'cinetpay_notify', 'get_user_info'];
...
if (in_array($action, [
    ...
    'update_payment_status','save_payroll_status','get_payroll_statuses'
])) {
