        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ 
            ...
            <div style={{ borderRight: '1px solid rgba(255, 255, 255, 0.08)', paddingRight: '20px' }}>
              ...
              <div style={{ marginTop: '6px', fontSize: '0.76rem', color: '#cbd5e1', background: 'rgba(15, 23, 42, 0.6)', padding: '4px 10px', borderRadius: '10px', border: '1px solid rgba(255, 255, 255, 0.08)', display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ marginTop: '6px', fontSize: '0.76rem', color: '#cbd5e1', background: 'rgba(15, 23, 42, 0.6)', padding: '4px 10px', borderRadius: '10px', border: '1px solid rgba(255, 255, 255, 0.08)', display: 'inline-flex', alignItems: 'center', gap: '5px', justifyContent: 'flex-end' }}>
