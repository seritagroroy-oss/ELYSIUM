...
switch ($action) {
    ...
    case 'get_user_info':
        ...
        $sqlite = getDb();
        $stmt_user = $sqlite->prepare("SELECT profile_photo, has_seen_onboarding, phone, workspace_type, settings, status, maintenance_mode, force_password_change FROM users WHERE email = ?");
